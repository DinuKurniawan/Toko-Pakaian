...
<template>
    <Head title="Edit Banner | LUMIÈRE" />
                    ...
                    >
                        ...
                        <div>
                            ...
                            <div class="space-y-3">
                                ...
                                <div
                                    class="w-full max-h-48 rounded-xl overflow-hidden bg-gray-100"
                                >
                                    <img
                                        :src="
                                            imagePreview ||
                                ...
                                <label
                                    class="flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-xl py-6 px-4 cursor-pointer hover:border-indigo-400 hover:bg-indigo-50/50 transition-colors"
                                >
                                    <svg
                        ...
                        >
                            ...
                            >
                                ...
                                <span v-else>Perbarui Banner</span>
                            </button>
                            <Link
                                :href="route('admin.banners.index')"
