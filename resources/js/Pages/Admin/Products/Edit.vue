...
const defaultStock = {};
ALL_SIZES.forEach(s => {
    defaultStock[s] = props.product.stock?.[s] ?? 0;
});
...
<template>
    <Head title="Edit Produk | LUMIÈRE" />
                    ...
                    >
                        ...
                        <div>
                            ...
                            <select
                                ...
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm bg-white"
                            >
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <label
                                    class="flex-1 flex flex-col items-center justify-center border-2 border-dashed border-gray-300 rounded-xl py-6 px-4 cursor-pointer hover:border-indigo-400 hover:bg-indigo-50/50 transition-colors"
                                >
                                    <svg
                                    ...
                                    <span class="text-sm text-gray-500"
                                        >Klik untuk ganti gambar</span
                                    >
                                    <span class="text-xs text-gray-400 mt-1"
                                        >JPG, PNG max 2MB (opsional)</span
                                    >
                                    <input
                                        type="file"
                                        accept="image/*"
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <label
                                ...
                                >Tampilkan sebagai produk unggulan di halaman
                                utama</label
                            >
                        </div>
