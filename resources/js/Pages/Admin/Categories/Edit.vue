...
<template>
    <Head title="Edit Kategori | LUMIÈRE" />
    ...
    <div class="min-h-screen bg-gray-50 flex font-sans text-gray-900">
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-hidden">
            ...
            <main class="flex-1 overflow-y-auto p-4 sm:p-6 lg:p-8">
                <div class="max-w-xl">
                    <h1 class="text-3xl font-bold text-gray-900 mb-8">Edit Kategori</h1>
                    ...
                    <form @submit.prevent="submit" class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-6">
                        <div>
                            ...
                            <input v-model="form.name" type="text" class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 text-sm" />
                        ...
                        <div>
                            ...
                            <div class="flex items-center gap-4">
                                <div class="w-20 h-20 rounded-xl overflow-hidden bg-gray-100 flex-shrink-0 flex items-center justify-center">
                                    <img v-if="imagePreview" :src="imagePreview" class="w-full h-full object-cover" />
                                    <img v-else-if="getImageUrl(category.image)" :src="getImageUrl(category.image)" class="w-full h-full object-cover" />
