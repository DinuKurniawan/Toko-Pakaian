...
<template>
    ...
    <div class="min-h-screen bg-white font-sans text-gray-900 flex flex-col">
        ...
        <main class="flex-grow">
            ...
            >
                <div
                    class="absolute inset-0 bg-gradient-to-r from-amber-900/80 to-gray-900/60"
                ></div>
                <div class="relative z-10 text-center px-4 max-w-3xl mx-auto">
                    ...
                    <p class="text-lg text-gray-200 mb-6 max-w-xl mx-auto">
                        Jangan lewatkan koleksi terbaru yang sedang tren dan
                        eksklusif hanya di sini!
                    </p>
                    <Link
            ...
            <section class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <div
                                class="absolute top-2 left-2 bg-white px-2 py-1 rounded text-[10px] font-bold text-amber-600 uppercase tracking-wider shadow-sm z-10"
                            >
                                Baru
                            </div>
                            <button
                                @click="addToCart(product.id)"
                                class="absolute bottom-3 left-1/2 -translate-x-1/2 bg-white/90 backdrop-blur text-gray-900 font-semibold py-2 px-4 rounded-full shadow-md opacity-0 group-hover:opacity-100 transition-all duration-300 hover:bg-amber-600 hover:text-white text-xs w-[85%] z-10"
                            >
                                Tambah ke Keranjang
                            </button>
                        </div>
                        <div class="mt-4 px-1 flex flex-col justify-between">
                            <div>
                                <p
                                    class="text-xs text-amber-600 font-semibold mb-1 uppercase tracking-wider"
                                >
                                    {{ product.category }}
                                </p>
                                <h3
                ...
                >
                    ...
                    <h3 class="text-lg font-medium text-gray-900">
                        Belum ada koleksi baru
                    </h3>
                    <p class="mt-1 text-sm text-gray-500 max-w-sm">
                        Koleksi terbaru sedang dipersiapkan. Silakan cek kembali
                        nanti.
                    </p>
                    <Link
                        href="/products"
                        class="mt-6 inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-full text-amber-700 bg-amber-100 hover:bg-amber-200"
                    >
                        Lihat Semua Produk
                    </Link>
                </div>
